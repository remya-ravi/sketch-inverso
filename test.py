...
BUILDING_SKETCH_PATH = 'CelebA_Sketch12'
BUILDING_IMAGE_PATH = 'img_align_celeba12'
...
def test_faces(weights=None):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in range(num_batches):
            ...
            val=model.evaluate(X,[Y,W],verbose=0)
            print("Test:Epoch#",epoch,"|Batch#", batch, ":", tes[0], ":",tes[3], ":",tes[4])
            print("Validation :Epoch#",epoch,"|Batch#", batch, ":", val[0], ":",val[3], ":",val[4])
